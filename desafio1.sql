...
CREATE TABLE SpotifyClone.payment_plans (
...
CREATE TABLE SpotifyClone.users (
  ...
  FOREIGN KEY (user_plan) REFERENCES payment_plans (plan_id)
) engine = InnoDB;
...
INSERT INTO
  SpotifyClone.payment_plans (plan_name, plan_price)
VALUES
  ('gratuito', 0),
  ('familiar', 7.99),
  ('universitário', 5.99),
...
VALUES
  ('Thati', 1, 23, DATE('2019-10-20')),
  ('Cintia', 2, 35, DATE('2017-12-30')),
  ('Bill', 3, 20, DATE('2019-06-05')),
  ('Roger', 4, 45, DATE('2020-05-13')),
  ('Norman', 4, 58, DATE('2017-02-17')),
  ('Patrick', 2, 33, DATE('2017-01-06')),
  ('Vivian', 3, 26, DATE('2018-01-05')),
  ('Carol', 3, 19, DATE('2018-02-14')),
  ('Angelina', 2, 42, DATE('2018-04-29')),
  ('Paul', 2, 46, DATE('2017-01-17'));
INSERT INTO
...
VALUES
  ...
  (10, 6);
INSERT INTO
  SpotifyClone.reproduction_history (user_id, song_id, date_reproduction)
VALUES
